...
import { ManualEmailInputSchema, SendEmailInputSchema } from '../../schema/email';
import type { ManualEmailInput, SendEmailInput } from '../../schema/email';
import {
...
export const validateManualEmailInput = ajv.compile<ManualEmailInput>(ManualEmailInputSchema);

export const validateSendEmailInput = ajv.compile<SendEmailInput>(SendEmailInputSchema);
...
export function formatManualEmailInputErrors(errors: ErrorObject[] | null | undefined): string {
  return ajv.errorsText(errors);
}

export function formatSendEmailInputErrors(errors: ErrorObject[] | null | undefined): string {
  return ajv.errorsText(errors);
}
