...
import type { ConfirmQSLSendInput, CreateQSLReceiveInput, CreateQSLSendInput } from '@schema/qsl';
export type { CreateAddressRequest } from '@schema/address';
export type { CreateCommunicationLogInput } from '@schema/communicationLog';
export type { ManualEmailInput } from '@schema/email';
export type { ConfirmQSLSendInput, CreateQSLReceiveInput, CreateQSLSendInput } from '@schema/qsl';
...
export function manualUpdateEmail(options: ManualEmailInput): Promise<void> {
  return sendData<ManualEmailInput>('/api/update/manual-email', options);
}
